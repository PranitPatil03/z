  ...
  await db.insert(siteSnapImages).values([
    {
      ...
      imageUrl: "https://cdn.anvil.local/seed/site-snaps/harbor-core-1.jpg",
      position: 0,
      createdAt: daysAgo(2),
    },
    {
      id: "snapimg_harbor_2",
      snapId: "snap_harbor_core",
      imageUrl: "https://cdn.anvil.local/seed/site-snaps/harbor-core-2.jpg",
      position: 1,
      createdAt: daysAgo(2),
    },
    {
      ...
      imageUrl: "https://cdn.anvil.local/seed/site-snaps/data-roof-1.jpg",
      position: 0,
      createdAt: daysAgo(1),
    },
  ]);
