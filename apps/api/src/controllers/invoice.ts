...
export async function createInvoiceController(request: Request, response: Response) {
...
export async function updateInvoiceController(request: Request, response: Response) {
  const data = await invoiceService.update(request);
  response.json({ data });
}

export async function archiveInvoiceController(request: Request, response: Response) {
