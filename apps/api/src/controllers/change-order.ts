...
export async function listChangeOrdersController(
  request: Request,
  response: Response,
) {
...
export async function createChangeOrderController(
  request: Request,
  response: Response,
) {
...
export async function getChangeOrderController(
  request: Request,
  response: Response,
) {
...
export async function updateChangeOrderController(
  request: Request,
  response: Response,
) {
...
export async function submitChangeOrderController(
  request: Request,
  response: Response,
) {
...
export async function decideChangeOrderController(
  request: Request,
  response: Response,
) {
...
export async function listChangeOrderAttachmentsController(
  request: Request,
  response: Response,
) {
...
export async function attachChangeOrderFileAssetController(
  request: Request,
  response: Response,
) {
...
export async function detachChangeOrderFileAssetController(
  request: Request,
  response: Response,
) {
