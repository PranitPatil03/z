...
export async function syncSmartMailAccountController(request: Request, response: Response) {
  const data = await smartMailService.syncAccount(request);
  response.json({ data });
}

export async function createSmartMailDraftController(request: Request, response: Response) {
  const data = await smartMailService.createDraft(request);
  response.status(201).json({ data });
}

export async function updateSmartMailMessageLinkController(request: Request, response: Response) {
  const data = await smartMailService.overrideMessageLink(request);
  response.json({ data });
}

export async function listSmartMailTemplatesController(request: Request, response: Response) {
  const data = await smartMailService.listTemplates(request);
  response.json({ data });
}

export async function createSmartMailTemplateController(request: Request, response: Response) {
  const data = await smartMailService.createTemplate(request);
  response.status(201).json({ data });
}

export async function updateSmartMailTemplateController(request: Request, response: Response) {
  const data = await smartMailService.updateTemplate(request);
  response.json({ data });
}

export async function deleteSmartMailTemplateController(request: Request, response: Response) {
