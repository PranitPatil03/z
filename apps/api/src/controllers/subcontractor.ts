...
export async function updateSubcontractorController(
  request: Request,
  response: Response,
) {
...
export async function archiveSubcontractorController(
  request: Request,
  response: Response,
) {
...
export async function inviteSubcontractorPortalController(
  request: Request,
  response: Response,
) {
