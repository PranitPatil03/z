...
export async function setActiveOrganizationController(
  request: Request,
  response: Response,
) {
...
export async function checkOrganizationSlugController(
  request: Request,
  response: Response,
) {
...
export async function listUserInvitationsController(
  request: Request,
  response: Response,
) {
...
export async function rejectInvitationController(
  request: Request,
  response: Response,
) {
...
export async function getActiveMemberController(
  request: Request,
  response: Response,
) {
...
export async function getActiveMemberRoleController(
  request: Request,
  response: Response,
) {
...
export async function listOrganizationTeamsController(
  request: Request,
  response: Response,
) {
...
export async function removeTeamController(
  request: Request,
  response: Response,
) {
...
export async function setActiveTeamController(
  request: Request,
  response: Response,
) {
...
export async function listUserTeamsController(
  request: Request,
  response: Response,
) {
