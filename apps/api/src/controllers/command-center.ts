...
export async function getCommandCenterOverviewController(
  request: Request,
  response: Response,
) {
...
export async function getCommandCenterHealthController(
  request: Request,
  response: Response,
) {
...
export async function getCommandCenterPortfolioController(
  request: Request,
  response: Response,
) {
...
export async function getCommandCenterTrendsController(
  request: Request,
  response: Response,
) {
